...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('tcl.addInfo')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="phone1"  placeholder="Phone 1" id="phone1" required>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="phone2"  placeholder="Phone 2" id="phone2" required>
                            </div>
