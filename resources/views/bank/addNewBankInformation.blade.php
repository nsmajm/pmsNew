    ...
    <div class="col-12">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                    ...
                    <form method="post" action="{{route('bank.saveNewBankInformation')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group row">
                            <label for="example-search-input" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="bankName" placeholder="name"  id="example-search-input" required>
                            </div>
